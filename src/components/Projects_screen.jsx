        ...
        return(
            <div className="h-4/5 flex justify-center items-center sm:flex-col sm:h-full sm:gap-5 tall:items-start m:items-start s:flex-col s:h-full s:gap-5 ">
                 <div className="flex-col  w-[400px] h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105 sm:w-4/5 sm:h-4/5  dark:border-2 dark:shadow-white dark:shadow-lg s:w-4/5 s:h-4/5 " onClick={()=> window.open("https://github.com/Neson55/Website-Front")}>
                   <img src="./project_images/social_network.png" alt="social_network" className="flex  w-full h-2/3 sm:h-2/3 m:h-60"/>
                ...
                <div className="flex-col  w-[400px] h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105 sm:w-4/5 sm:h-4/5 dark:border-2 dark:shadow-white dark:shadow-lg s:w-4/5 s:h-4/5" onClick={()=> window.open("https://github.com/Neson55/Post_Js")}>
                ...
                <div className="flex-col   w-[400px] h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105 sm:w-4/5 sm:h-4/5 dark:border-2 dark:shadow-white dark:shadow-lg s:w-4/5 s:h-4/5" onClick={()=> window.open("https://github.com/Neson55/bootstrap-5")}>
                ...
                <div className="flex-col  w-[400px] h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105 sm:w-4/5 sm:h-4/5  dark:border-2 dark:shadow-white dark:shadow-lg s:w-4/5 s:h-4/5 ">

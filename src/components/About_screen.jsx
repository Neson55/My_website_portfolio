...
function About_screen({color}) {
  ...
  return (
    <div className="h-4/5 flex-col sm:mb-0 s:mb-0 ">
      ...
      <div className="flex h-1/2 justify-center ml-32 sm:flex-col sm:h-52 sm:ml-0 sm:mt-24 sm:mb-40  m:flex-col m:h-52 m:ml-0 m:mt-24 m:mb-40  s:flex-col s:h-52 s:ml-0 s:mt-24 s:mb-40">

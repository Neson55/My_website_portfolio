    ...
    return (
        <div className='h-1/10 flex justify-between p-4 sm:h-1/10 sm:flex sm:justify-between'>
            ...
            <div className='flex text-xl gap-4 mr-20 sm:mr-2 sm:mt-1'>
                ...
                <div onClick={handleRefresh}><Link to={"/"} className='hover:underline'>Home</Link></div>  
                <div onClick={handleRefresh}><Link to={"/about"} className='hover:underline'>About</Link></div>

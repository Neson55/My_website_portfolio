...
function Projects_screen () {
        ...
        return(
            <div className="h-4/5 flex  justify-center items-center ">
                <div className="flex-col  w-1/4 h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105" onClick={()=> window.open("#")}>
                ...
                <div className="flex-col  w-1/4 h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105" onClick={()=> window.open("#")}>
                 ...
                 <div className="flex-col  w-1/4 h-2/3 ml-10 p-4 rounded-lg justify  shadow-2xl hover:scale-105" onClick={()=> window.open("#")}>
                   <img src="./project_images/Cat (1).gif" alt="#" className="flex  w-full h-2/3"/>
